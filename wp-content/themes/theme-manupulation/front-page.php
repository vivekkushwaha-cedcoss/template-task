...
<div class="main-banner header-text">
	...
	<div class="owl-banner owl-carousel">
		...
		<div class="item">
			...
			$output       = ( has_post_thumbnail() ) ? the_post_thumbnail() :
		...
		<div class="item-content">
			...
			?>
			<a href="<?php echo esc_html( $post_slug ); ?>"><h4>
				<?php the_title(); ?>
			</h4></a>
			<ul class="post-info">
				<li><a href="#"><?php echo get_the_author(); ?></a></li>
				<li><a href="#"><?php echo get_the_date(); ?></a></li>
				<li><a href="#"><?php echo esc_html( get_comments_number() ); ?> comments</a></li>
			</ul>
			</div>
		</div>
		</div>
			...
			<div class="col-lg-12">
				...
				<div class="down-content">
					...
					<?php
						...
						$post_slug = $post->post_name;
					?>
					<a href="<?php echo esc_html( '/post/' . $post_slug ); ?>">
						<h4>
							<?php
							the_title();
							?>
					...
					<li><a href="#"><?php echo get_the_date(); ?></a></li>
					<li>
						<a href="#"><?php echo esc_html( get_comments_number() ); ?> 
							comments
						</a>
					</li>
					</ul>
